...
changeToLogin=document.getElementById("changeToLoginBtn");
...
// Display the login Form page by clicking the "Already have an account Login"
...
changeToLogin.addEventListener('click',displayLogInForm)